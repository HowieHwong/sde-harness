...
from sde_harness.core import Generation, Prompt, Oracle
...
def setup_generator(models_file: str = "models.yaml", credentials_file: str = "credentials.yaml") -> Generation:
    """
    ...
    Returns:
        Generator instance
    """
    # Always use files from the sde-harness root directory
