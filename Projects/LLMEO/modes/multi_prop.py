...
def run_multi_prop(args) -> Dict[str, Any]:
    ...
    text_tmc = make_text_for_existing_tmcs(tmc_samples, LIG_CHARGE, ["gap", "polarisability"])
    ...
    print(f"✅ Multi-property optimization completed! Final score: {result['final_scores']}")
    return result
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Multi-property optimization mode test")
