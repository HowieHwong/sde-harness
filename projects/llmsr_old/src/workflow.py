...
class LLMSRWorkflowSync(Workflow):
    ...
    def discover_equation_sync(self, 
        ...
        dynamic_prompt_fn = EquationPromptTemplates.create_dynamic_prompt_function(
    ...
    def print_summary(self):
        ...
        for problem_name, result in self.results.items():
            ...
            if best_equation:
                ...
                from src.core.generation import LLMSRGeneration
