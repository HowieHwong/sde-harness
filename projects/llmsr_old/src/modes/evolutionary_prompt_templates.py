"""Evolutionary prompt templates for equation discovery tasks with selective example inclusion."""

from typing import Dict, Any, List, Optional
from sde_harness.core import Prompt

from core.evolutionary_buffer import EvolutionaryBuffer, EquationProgram
